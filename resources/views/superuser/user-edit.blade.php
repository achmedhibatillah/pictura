    ...
    <div class="col-11 col-md-10 col-xl-8 m-0 px-3 pt-3 pb-5 bg-clrsec" style="max-width:1200px;min-height:100vh;">
        <div class="row m-0 p-0 justify-content-center">
            <div class="col-md-8 m-0 p-0">
                ...
                <div class="card m-0 p-3 mb-2 position-relative">
                    <a href="{{ url('manage-users') }}" class="td-hover"><i class="fa-solid fa-arrow-turn-down position-absolute text-clr1 cursor-pointer" style="transform:rotate(90deg)"></i></a>
                    <p class="m-0 text-center">Edit {{ $user['user_fullname'] }} Profile</p>
                </div>
                <div class="card m-0 p-3 mb-2 text-center">
                    <p class="fsz-11 m-0 text-secondary">User ID :</p>
                    <p class="m-0 text-secondary">{{ $user['user_id'] }}</p>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-light rounded-m">
            ...
            <div class="modal-body">
                <form action="{{ url('manage-users/update/email') }}" id="formEditEmail" method="post" class="text-clr2">
                    @csrf
...
<div class="modal fade" id="modalEditPass" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-light rounded-m">
            ...
            <div class="modal-body">
                <form action="{{ url('manage-users/update/pass') }}" id="formEditPass" method="post" class="text-clr2">
                    @csrf
                    <input type="hidden" name="user_id" value="{{ $user['user_id'] }}">
...
<div class="modal fade" id="modalEditPhoto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-light rounded-m">
            ...
            <div class="modal-body">
                <form action="{{ url('manage-users/update/photo') }}" id="formEditPhoto" method="post" enctype="multipart/form-data" class="text-clr2">
                    @csrf
                    <input type="hidden" name="user_id" value="{{ $user['user_id'] }}">
                    <div class="">
...
<div class="modal fade" id="modalEditName" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-light rounded-m">
            ...
            <div class="modal-body">
                <form action="{{ url('manage-users/update/name') }}" id="formEditName" method="post" class="text-clr2">
                    @csrf
                    <input type="hidden" name="user_id" value="{{ $user['user_id'] }}">
                    <div class="mb-3">
